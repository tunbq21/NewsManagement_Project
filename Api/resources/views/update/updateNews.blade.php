                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{$news->Title}}" name="Title" class="form-control" placeholder="Nhập tên tiêu đề">
                        </div>
                        <div class="form-group">
                            <strong>Nội dung</strong>
                            <input type="text" value="{{$news->Content}}" name="Content" class="form-control" placeholder="Nhập nội dung">
                        </div>
                        <div class="form-group">
                            <strong>Đường dẫn</strong>
                            <input type="text" value="{{$news->News_Url}}" name="News_Url" class="form-control" placeholder="Nhập đường dẫn">
                        </div>
                    </div>
                    <div class="col-md-6">
                        {{-- <div class="form-group">
